# Gemini CLI — Movie Finder project context

Foundational mandate for Gemini CLI in this repository.
...
## Session start protocol (Gemini CLI)
...
5. **Plan first** (use `enter_plan_mode` for non-trivial changes)
